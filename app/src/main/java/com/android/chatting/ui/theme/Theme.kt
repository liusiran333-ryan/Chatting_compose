package com.android.chatting.ui.theme
...
private object LightColors : IChattingColors {
...
private object DarkColors : IChattingColors {
...
class ChattingColors : IChattingColors {
...
fun ChattingTheme(
    ...
    val chattingColors = ChattingColors()
    if (darkTheme) {
        chattingColors.toggleToDarkColor()
    } else {
        chattingColors.toggleToLightColor()
    }
    val colorScheme = when {
        ...
        darkTheme -> MD_DarkColors
        else -> MD_LightColors
    }

    CompositionLocalProvider(LocalChattingColors provides chattingColors) {
        MaterialTheme(
